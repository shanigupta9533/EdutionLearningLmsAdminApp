...
import com.edutionAdminLearning.core_ui.view.dialog.handleCompleteUiApiError
import com.edutionAdminLearning.core_ui.view.dialog.handleSuccessDialog
import com.edutionAdminLearning.core_ui.view.dialog.handleUiApiError
...
class PathshalaFragment: ViewModelBindingDialogFragment<FragmentPathshalaBinding, PathshalaViewModel>(
 ...
 */
abstract class ViewModelBindingDialogFragment<VB : ViewBinding, VM : BaseViewModel>(
    bindingFactory: (LayoutInflater) -> VB,
) : ViewBindingDialogFragment<VB>(bindingFactory) {
