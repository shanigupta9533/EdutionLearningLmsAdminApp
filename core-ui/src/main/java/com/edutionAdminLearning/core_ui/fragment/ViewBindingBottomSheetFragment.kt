...
/**
 * Use this fragment class as base class if you have to deal with data binding in bottom sheet fragment.
 * While extending this class follow the below mentioned coding pattern
 *
 *  class ChildFragment: ViewBindingBottomSheetFragment<FragmentChildBinding>(FragmentChildBinding::inflate)
 *
